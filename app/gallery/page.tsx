  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-12 px-4 bg-gradient-to-b from-secondary to-background text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">DOLPHIN TUTORIALS Gallery.</h1>
        <p className="text-lg text-foreground/80">Explore memorable moments from DOLPHIN TUTORIALS.</p>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-secondary to-accent">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-foreground/80 mb-8">
            Join DOLPHIN TUTORIALS and create memories of academic excellence and holistic development.
          </p>
          <Link href="/contact">
