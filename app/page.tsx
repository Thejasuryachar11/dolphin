...
export default function Home() {
  ...
  // Slideshow images
  const images = [
    "/front1.jpg?height=400&width=500&query=classroom students studying together",
    "/front2.png",
    "/pp.jpeg",
    "/4.jpg",
    "/front.jpg",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-up">
              ...
              <p className="text-lg text-foreground/80 mb-8">
                DOLPHIN TUTORIALS provides a nurturing environment that helps students from 1st to 10th standard
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="https://wa.me/919206925526" target="_blank" rel="noopener noreferrer">
  ...
  <Image
    src="/sir1.jpeg"
    alt="Founder – Professional Portrait"
    fill
  ...
  />
              ...
              <div className="md:col-span-2">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-foreground">10+ years teaching experience</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-accent flex-shrink-0 mt-1" />
          ...
          <div className="bg-secondary/50 rounded-lg p-8 mb-12">
            <h3 className="text-2xl font-bold text-primary mb-6">Why Choose DOLPHIN TUTORIALS?</h3>
          ...
          <section className="py-20 px-4 bg-primary text-primary-foreground">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-lg opacity-90 mb-8">
                Join DOLPHIN TUTORIALS and give your child a strong foundation for academic success and bright
                future.
              </p>
  ...
  <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 animate-fade-in">
    <Card className="max-w-2xl w-full max-h-96 overflow-y-auto p-8">
      ...
      <div className="space-y-4 text-foreground/80 text-justify">
        ...
        <p>
          Under his leadership, DOLPHIN TUTORIALS has achieved a 99% board exam success rate and has
          become a trusted name for quality tutoring in T. Dasarahalli. He combines modern teaching methodologies
