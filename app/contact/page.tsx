...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = `Hello! I would like to inquire about admission for DOLPHIN TUTORIALS.
...
Please provide details about admission, fees, and schedule.`
      ...
      const whatsappUrl = `https://wa.me/9206925526?text=${encodedMessage}`
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4 animate-slide-up">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-1">
                      <a href="tel:+919206925526" className="text-foreground/80 hover:text-primary transition-colors">
                        +91 92069 25526
                      </a>
                      <a
                        href="tel:+919740565647"
                ...
                <div className="p-6 bg-secondary rounded-lg">
                  ...
                  <p className="text-foreground/80 text-sm">Instagram: @dolphin_tutorials</p>
                </div>
              </div>
            </div>
